...
PRODUCT_KEY = "LSGtzW4yq9hjggJTvf8WmisN5Rq9QWWs"                                                                           
--require "myUpdate"
--myUpdate.request(nil,"schoolandyouapi.aboutnew.net/pati/SOCKET_LONG_CONNECTION_1.0.0_Luat_V0025_ASR1802_720G.bin")
